...
Repository: `KG-NINJA/aMAGIgoesystem`.
...
Existing CI/deployment definitions: `.github/workflows/magi-fusion.yml`, `.github/workflows/magi_multistage.yml`, `.github/workflows/magi_multistage_robust.yml`. Inspect applicable triggers before push/merge. A workflow filename alone does not prove a deploy target or successful deployment.
